...
public class BaseTest {
	...
	Assert.assertTrue(driver.findElement(By.xpath("//td[@class='dataTables_empty']")).isDisplayed());
		Assert.assertTrue(pageSource2.contains("No Matching Records Button"),";
	...
	home.ClickOnMarketing();Thread.sleep(2000);
	//To click on push notifications
	home.ClickOnPushNotification();Thread.sleep(2000);
	//To add new notification
    home.ClickonAddButton();Thread.sleep(2000);
    //To enter notification name
    home.EnterNotificationName(notification);Thread.sleep(2000);
    //To enter notification msg
    home.EnetrNotificationMsg(notification1);Thread.sleep(2000);
    //To upload notification image
    home.UploadNotificationImage();Thread.sleep(2000);
